...
@section('content')
    <div class="card">
        <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;margin-bottom:16px;">
            <h2 style="margin:0;border:none;padding:0;">Tambah Mahasiswa</h2>
        ...
        <form action="{{ route('mahasiswa.store') }}" method="POST">
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="text" name="nama" value="{{ old('nama') }}" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;" required>
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="text" name="nim" value="{{ old('nim') }}" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;" required>
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="text" name="prodi" value="{{ old('prodi') }}" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;" required>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
                <div>
                    ...
                    <input type="number" name="angkatan" value="{{ old('angkatan') }}" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;" required>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="ipk" value="{{ old('ipk') }}" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;" required>
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="email" name="email" value="{{ old('email') }}" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;">
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="url" name="github" value="{{ old('github') }}" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;">
            ...
            <div style="margin-bottom:20px;">
                ...
                <textarea name="bio" rows="3" style="width:100%;padding:10px 14px;border:1px solid #ccc;border-radius:8px;font-size:1rem;resize:vertical;">{{ old('bio') }}</textarea>
                @error('bio') <span style="color:red;font-size:0.85rem;">{{ $message }}</span> @enderror
            </div>

            <button type="submit" style="background:#21B0A7;color:white;padding:12px 28px;border:none;border-radius:8px;font-size:1rem;font-weight:600;cursor:pointer;">Simpan</button>
        </form>
    </div>
@endsection
